package com.fukaimei.volleytest;
...
//                UseImageLoader();
    ...
    private void UseImageRequest() {
        ImageRequest imageRequest = new ImageRequest(
                "https://tva4.sinaimg.cn/crop.0.0.180.180.180/767c1351jw1e8qgp5bmzyj2050050aa8.jpg",
    ...
    private void UseImageLoader() {
        ...
        imageLoader.get("https://tva4.sinaimg.cn/crop.0.0.180.180.180/767c1351jw1e8qgp5bmzyj2050050aa8.jpg", listener);
    }
    ...
    private void UseNetworkImageView() {
        ...
        nv_image.setImageUrl("https://tva4.sinaimg.cn/crop.0.0.180.180.180/767c1351jw1e8qgp5bmzyj2050050aa8.jpg",
                imageLoader);
